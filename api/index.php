...
if(!empty($_POST['email']) && !empty($_FILES['resume']['name'])) {
    try {
        $from_email = 'info@ecomaxlubricant.com'; // sender email address
        ...
        if ($error > 0) {
            $responseArr['message'] = 'Upload error or no files uploaded.';
